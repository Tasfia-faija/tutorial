<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="True" CodeBehind="AddProduct.aspx.cs" Inherits="WebApplication5.AddProduct" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <asp:Label ID="Label17" runat="server" CssClass="col-md-2 control-label" Text="07 Days Return"></asp:Label>
                <div class="col-md-3">
                    <asp:CheckBox ID="ch07Ret" runat="server" />
                </div>
            </div>
